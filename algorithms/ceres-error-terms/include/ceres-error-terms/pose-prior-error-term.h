#ifndef CERES_ERROR_TERMS_POSE_PRIOR_ERROR_TERM_H_
#define CERES_ERROR_TERMS_POSE_PRIOR_ERROR_TERM_H_
...
class PosePriorErrorTerm
    : public ceres::SizedCostFunction<poseblocks::kResidualSize,
                                      poseblocks::kOrientationBlockSize,
 ...
 private:
  ...
  enum { kIdxOrientation, kIdxPosition };

  // The representation for Jacobian computed by this object.
  typedef Eigen::Matrix<double, poseblocks::kResidualSize,
                        poseblocks::kOrientationBlockSize, Eigen::RowMajor>
      OrientationJacobian;
  typedef Eigen::Matrix<double, poseblocks::kResidualSize,
                        poseblocks::kPositionBlockSize, Eigen::RowMajor>
      PositionJacobian;
...
#endif  // CERES_ERROR_TERMS_POSE_PRIOR_ERROR_TERM_H_
