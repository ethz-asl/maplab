#ifndef CERES_ERROR_TERMS_LIDAR_ERROR_TERM_FACTORY_H_
#define CERES_ERROR_TERMS_LIDAR_ERROR_TERM_FACTORY_H_
...
#include "ceres-error-terms/lidar-error-term-factory-inl.h"

#endif  // CERES_ERROR_TERMS_LIDAR_ERROR_TERM_FACTORY_H_
