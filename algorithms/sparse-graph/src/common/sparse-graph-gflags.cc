...
DEFINE_bool(
    ...
    "If true, the adjacency edge weights include rotational weights.");
DEFINE_bool(
...
DEFINE_bool(
    sparse_graph_include_temporal_decay, false,
    "If true, the adjacency edge weights include temporal decays.");
DEFINE_double(
