...
bool FeatureTrackerGyroAided::processNFrame(
  ...
  integrateInterframeImuRotation(
      imu_timestamps_since_last_nframe, imu_measurements_since_last_nframe,
      &q_Ikp1_Ik);
  ...
  tracker_pipeline_->processImages(
      camera_system_, q_Ikp1_Ik, curr_nframe_images, prev_nframe_images_,
