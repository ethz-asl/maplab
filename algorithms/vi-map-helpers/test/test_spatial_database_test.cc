...
template <>
void SpatialDatabaseTest<vi_map::LandmarkId>::createObjects() {
...
template <>
void SpatialDatabaseTest<
    vi_map::LandmarkId>::createAlternateMissionObjects() {
  T_G_V_.getPosition() << 0, 0, -10;
...
TYPED_TEST(SpatialDatabaseTest, getGridResolution) {
  ...
  SpatialDatabase<TypeParam> spatial_db(this->map_, grid_resolution_reference);
